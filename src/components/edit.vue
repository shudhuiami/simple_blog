            ...
            <div class="postProcessor">
                <form class="postProcessor_inner" v-on:submit.prevent="updatePost">
                    ...
                    <div v-if="editForm !== null">
                        <input v-model="editForm.title" type="text" class="post_title" name="title"
                               placeholder="Post title">
                        <div class="margin-10"></div>
                        <textarea v-model="editForm.body" class="post_body" placeholder="Your Post"
                                  name="post_body"></textarea>
                        <div class="margin-10"></div>
                        <div class="margin-10"></div>
                        <div class="form_actions">
                            <a class="action_trigger gray" v-on:click="closeEditForm">Close</a>
                            <button type="submit" class="action_trigger">Post</button>
                        </div>
                    </div>
                </form>
            </div>
...
<style>
    @import "../assets/css/create/style.css";
</style>
